...
<template>
    <div class="bg-[#F7FAFC]" style="font-family: 'Inter'">
        <div class="container mx-auto">
            <div class="py-[30px]">
                <h1 class="mb-[25px] font-semibold text-[26px] text-[#1C1C1C]">My cart ({{ cart.length }})</h1>
                <div style="display: grid; grid-template-columns: 75% 23.5%;" class="gap-[22px]">
                    <div>
                        <div
                            ...
                            <div class="flex justify-between mt-[22px]">
                                <button
                                    class="flex items-center hover:cursor-pointer bg-[#0D6EFD] hover:bg-[#0045ab] duration-300 rounded-[8px] py-[13px] px-[16px] text-white text-[18px] font-medium"><i
                                        class='bx bx-left-arrow-alt text-[25px] mr-[15px]'></i> Back to shop</button>
                                <button
                                    class="flex items-center hover:cursor-pointer border-[1px] text-[#0D6EFD] border-[#DEE2E7] duration-300 rounded-[8px] py-[13px] px-[16px] hover:bg-[#0D6EFD] hover:text-white text-[18px] font-medium"><i
                    ...
                    <div>
                        <div class="py-[21px] px-[17px] bg-white border-[1px] mb-[25px] border-[#DEE2E7] rounded-[6px]">
                        ...
                        <div class="border-[1px] border-[#DEE2E7] rounded-[6px] bg-white py-[23px] px-[23px]">
                ...
                <div class="border-[1px] border-[#DEE2E7] bg-white p-[22px] rounded-[6px] mb-[25px]">
                ...
                <div class="bg-[#005ADE] flex items-center justify-between py-[30px] px-[33px] rounded-[10px]">
                    ...
                    <button class="font-medium text-[18px] bg-[#FF9017] border-[1px] border-[#FF9017] hover:bg-white hover:text-[#FF9017] duration-300 py-[13px] px-[19px] text-white rounded-[8px]">Shop now</button>
                </div>
            </div>
